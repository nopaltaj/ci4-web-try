...
-moz-box-shadow: 0px 4px 11px 0px rgb(0 0 0 / 53%); ">
    ...
    <div class="row " style="width: auto;">
        ...
        <div class="m-5 col">
            <h1 style="font-size: 30px;">Input Surat</h1>
            <form action="<?= base_url('surateditProses') ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" class=" date form-control" id="created_at" name="created_at"  value="<?= esc($data_surat['created_at']); ?>" >

            </div>

            <div class="mb-3">
                <label for="no_surat" class="form-label">No Surat</label>
                <input type="number" class=" date form-control" id="no_surat" name="no_surat" value="<?= esc($data_surat['no_surat']); ?>" >

            </div>

            <div class="mb-3">
                <label for="penerima" class="form-label">Penerima</label>
                <input type="text" class="form-control" id="penerima" name="penerima" value="<?= esc($data_surat['penerima']); ?>">
            </div>
