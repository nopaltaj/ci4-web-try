    ...
    <div class="row " style="width: auto;">
        <div class="d-flex flex-column flex-shrink-0 p-3 " style="width: 280px;  background-color: #274FC7 ; ">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item" >
                    <a href="<?php echo  base_url() . 'dashboard' ?>" class="nav-link active " aria-current="page" style="color: white;">
        ...
        <div class="m-5 col">
            <h1 style="font-size: 30px;">Edit Barang</h1>
            <form action="<?= base_url('barangeditProses') ?>" method="POST">
            <input type="hidden" class="form-control" id="id" name="id" value="<?= esc($data_barang['id']); ?>">
            <div class="mb-3">
                <label for="created_at" class="form-label">Tanggal Buat</label>
                <input type="date" class=" date form-control" id="created_at" name="created_at" value="<?= esc($data_barang['created_at']); ?>">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="resi" name="resi" value="<?= esc($data_barang['resi']); ?>">

            </div>
            <div class="mb-3">
                <label for="nama_barang" class="form-label">Nama Barang</label>
                <input type="text" class="form-control" id="nama_barang" name="nama_barang" value="<?= esc($data_barang['nama_barang']); ?>">
            </div>
            <div class="mb-3">
                <label for="penerima" class="form-label">Penerima</label>
                <input type="text" class="form-control" id="penerima" name="penerima" value="<?= esc($data_barang['penerima']); ?>">
            </div>
            <div class="mb-3">
                <label for="description" class="form-label">Deskripsi</label>
                <input type="text" class="form-control" id="description" name="description" value="<?= esc($data_barang['description']); ?>">
            </div>
