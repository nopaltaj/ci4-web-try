    ...
    <div class="row " style="width: auto;">
        ...
        <div class="m-5 col">
            ...
            <div class="d-flex justify-content-around mt-5">
                <a href="<?php echo base_url() . 'data-barang' ?>" class="btn btn-outline-dark">Laporan penerimaan barang</a>
                <a href="#" class="btn btn-primary">Laporan penerimaan Surat</a>
            </div>
                        ...
                        <?php foreach ($surat as $item): ?>
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    <a href="<?php echo  base_url() . 'dataSuratEdit' . '/' . esc($item['id']) ?>" class="badge bg-danger"><?= esc($item['status']); ?></a>
                                    <?php else: ?>
                                    <a href="<?php echo  base_url() . 'dataSuratEdit' . '/' . esc($item['id']) ?>"  class="badge bg-primary"><?= esc($item['status']); ?></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
